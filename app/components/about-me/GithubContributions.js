...
export default function GithubContributions({ data }) {
  ...
  return (
    <div className="mt-0.5 flex flex-col items-center w-full">
      <div className="w-[290px] max-w-xl bg-[#2D1B69] rounded-xl shadow-lg border border-purple-500/30 overflow-hidden relative min-h-40 sm:w-[400px] md:w-[600px] lg:w-full">

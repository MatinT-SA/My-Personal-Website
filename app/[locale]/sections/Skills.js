...
export default function Skills() {
  ...
  return (
    <section
      ...
      className="relative scroll-mt-24 mx-2 my-8 sm:mx-12 sm:my-16 rounded-lg sm:rounded-[150px_10px] lg:rounded-[250px_15px] bg-blue-light-transparent px-2 py-6 sm:px-6 sm:py-9"
    >

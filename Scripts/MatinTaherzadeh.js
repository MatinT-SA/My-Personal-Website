...
const appearOnScrollMainTitles = new IntersectionObserver(function (
  entries,
  appearOnScrollMainTitles
) {
  entries.forEach((entry) => {
    if (!entry.isIntersecting) {
      return;
...
const appearOnScrollSkills = new IntersectionObserver(function (
  entries,
  appearOnScrollSkills
) {
  entries.forEach((entry) => {
    if (!entry.isIntersecting) {
      return;
...
const appearOnScrollSkillsLE = new IntersectionObserver(function (
  entries,
  appearOnScrollSkillsLE
) {
  entries.forEach((entry) => {
    if (!entry.isIntersecting) {
      return;
...
const appearOnScrollResume = new IntersectionObserver(function (
  entries,
  appearOnScrollResume
) {
  entries.forEach((entry) => {
    if (!entry.isIntersecting) {
      return;
...
const appearOnScrollEntrepreneur = new IntersectionObserver(function (
  entries,
  appearOnScrollEntrepreneur
) {
  entries.forEach((entry) => {
    if (!entry.isIntersecting) {
      return;
...
const appearOnScrollContact = new IntersectionObserver(function (
  entries,
  appearOnScrollContact
) {
  entries.forEach((entry) => {
    if (!entry.isIntersecting) {
      return;
...
const appearOnScrollContactLE = new IntersectionObserver(function (
  entries,
  appearOnScrollContactLE
) {
  entries.forEach((entry) => {
    if (!entry.isIntersecting) {
      return;
...
const appearOnScrollComment = new IntersectionObserver(function (
  entries,
  appearOnScrollComment
) {
  entries.forEach((entry) => {
    if (!entry.isIntersecting) {
      return;
